---
title: "NPC Events"
description: Control NPCs in PS Maker with spawn, animation, patrol paths, and chase behavior. Build interactions, movement, and encounters that react to the player.
---
