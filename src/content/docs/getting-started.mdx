...
:::tip
Use [autotiles](./map-editor/autotile.mdx) for borders if you want patches of dirt or paths.
:::
...
Welcome to my very first Pixel Stories game!

```

4. Go to the **Play test** page. As soon as the map loads, the dialog will appear.
...
The rest of the docs has a lot of good information. Try building more maps, playing with the event system, and seeing how different mechanics come together. The more you experiment, the more you'll discover what possible in Pixel Stories.
...
- [Events System](./events-editor/events.md): Learn how to create dialog, choices, and gameplay mechanics
- [NPCs](./game-assets/npcs.mdx): Bring characters to life with animations and interactions

Have fun building maps, exploring the event system, and creating stories that are uniquely yours!

Join our [Discord community](https://discord.gg/XN9EaUh26g) if you’d like help or want to share what you’ve built!
