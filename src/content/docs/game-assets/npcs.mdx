---
title: "NPCs"
description: Create NPCs in Pixel Stories with idle and movement animations, sprite strips, and global settings. Spawn and control them with NPC events.
---
...
📸 _\[Screenshot: an NPC in the map]_
...
To control NPCs once they are in the game, see the [NPC Events](./npc-events.md) doc.
