...
description: Add inventory items in PS Maker to track keys, tools, and collectibles. Use events to give or remove items and conditionals to build mechanics.
---
