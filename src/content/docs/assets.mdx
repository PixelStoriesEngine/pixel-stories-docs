...
### Making Art Assets Compatible

Some assets have been made easy to import into Pixel Stories. However, not all art assets are in the right format to be put directly into the engine.
