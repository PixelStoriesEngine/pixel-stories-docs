---
title: "Tilesets in PS Maker"
description: Design your map terrain with tilesets in PS Maker. Create paths, walls, and landscapes by painting tiles directly onto your game world.
---
...
![](../../../assets/docs-images/map-editor/image-1.png)

Right now, all tiles in PS Maker are locked at 16px. Support for different tile sizes are planned for a future release.
...
2. Import from the **Asset Library**, which has open source assets already converted into PS Maker format

![](../../../assets/docs-images/map-editor/image-2.png)
...
![](../../../assets/docs-images/map-editor/gif-1.gif)
