...
📸 _\[Screenshot: Example autotile showing corners and borders filling automatically]_
...
Note: Do not use an autotile for the base terrain! If the tile covers most of the map, only the edges of the map will have those borders and corners. They are much better suited for small patches of terrain on top of the base terrain from a tileset.

📸 _\[Screenshot: Map with grass autotile blending into dirt]_
...
📸 _\[Screenshot: Diagram showing Wang format example]_
📸 _\[Screenshot: Diagram showing RPG Maker format example]_
...
📸 _\[Screenshot or gif better: User painting with autotiles on a map]_
