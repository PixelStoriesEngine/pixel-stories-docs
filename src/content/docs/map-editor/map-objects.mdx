...
Note: Map objects are static in the map and cannot be controlled by events. If you are looking for a dynamic and controllable object, use [NPCs](../game-assets/npcs.mdx) instead!
