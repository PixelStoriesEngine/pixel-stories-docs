...
📸 _\[Gif: Player walking behind a tree object]_
...
📸 _\[Screenshot: Example sprite strip]_
📸 _\[Gif: Animated version of that sprite strip in the game map]_
...
📸 _\[Screenshot: Collision box for a map object]_
