...
📸 _\[Screenshot: Example map showing tiles, objects, and collisions together]_
...
📸 _\[Screenshot: Toolbar while editing tiles]_
📸 _\[Screenshot: Toolbar while editing objects]_
...
📸 _\[Screenshot: Map settings panel with grid options highlighted]_
