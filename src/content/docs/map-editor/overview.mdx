...
description: Build game maps in PS Maker using tilesets, autotiles, objects, and collisions. Learn the tools to design worlds players will explore.
---

The **Map Editor** is where your world comes to life in PS Maker. It is the canvas where you design towns, forests, dungeons, or any kind of world your story needs. Everything you place here (tiles, objects, and collisions) decides how the player explores and interacts with your game.
...
- [Map Objects](./map-objects): Add trees, houses, and interactive details
