...
See [Tilesets](./tilesets.md), [Autotiles](./autotiles.md), [Objects](./map-objects.md), and [Collisions](./collisions.md) to learn more.
...
See [Events](./events.md) and [Event Groups](./event-groups.md) to learn more.
