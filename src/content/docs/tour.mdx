...
This interface tour gives you a glance at the main parts of the Pixel Stories editor.
...
See [Events](../events-editor/events) and [Event Groups](../events-editor/event-groups) to learn more.
