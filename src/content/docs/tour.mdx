...
- **Assets:** Add or edit player animations, NPCs, inventory items, variables, and dialogue UI
...
The **Events Editor** is where you create the mechanics of your game. Events drive the story and interactivity. Examples include dialogue, choices, showing images, or transferring the player.
