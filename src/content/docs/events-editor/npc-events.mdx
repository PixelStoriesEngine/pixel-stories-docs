...
📸 _\[Screenshot: NPC events visible in the Add Event menu]_
...
📸 _\[Screenshot: Small town scene with patrolling guard and shopkeeper idle]_
...
📸 _\[Screenshot: Editing a path by dragging points on the map]_
