...
To add an animation for the character, we will go back to the actor settings.
...
6. In the actor's walking animation set, select the corresponding animations for each direction. <br/>
