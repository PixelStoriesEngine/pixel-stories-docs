...
Thanks for going through this tutorial! We've gone through creating our map with terrain and objects, adding animations and actors, as well as a bit of the event system. Join us on [Discord](https://discord.gg/XN9EaUh26g) if you'd like to get more help or give feedback/suggestions.

To keep trying the engine, add the free default assets we provide for terrains and map objects! See [how to add default assets](/assets).
